...
Shipped this way: Arcade Night, Armored Allure, Bug Knight, Crimson Priestess, Cyber Samurai, Deadlight, Desert Nomad, Frozen Shrine, Ink Ronin, Kitsune Shrine, Lantern Hall, Library Cat, Maple Torii, Mars Colony, Moebius Pilot, Moonlit Oni, Neon Courier, Night Bus, Oni Lounge, Player Two, Rage Quit, Rain Courier, Ram Field, Ramen Night, Reaper, Red Vigil, Rogue Unit, Sky Whale, Solarpunk Haven, Station Window, Steel Horizon, Summer Coast, Toon Knight, Ukiyo Tide. Their backgrounds were rendered locally; see [background-prompts.md](background-prompts.md) for each recipe and prompt.
