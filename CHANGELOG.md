...
### Added
- **34 character and scene themes** (Cyber Samurai, Ukiyo Tide, Neon Courier, Toon Knight, ...), shipped as `assets/presets/*.json` with their own backgrounds. Each shows CPU/GPU load and temperature, RAM and VRAM.
